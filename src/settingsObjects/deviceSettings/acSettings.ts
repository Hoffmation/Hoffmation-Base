...
export class AcSettings extends DeviceSettings implements iAcSettings {
  /** The energy consumer settings for this AC */
  public energySettings: iExcessEnergyConsumerSettings = new ExcessEnergyConsumerSettings();
  /**
  ...
  public toJSON(): Partial<AcSettings> {
