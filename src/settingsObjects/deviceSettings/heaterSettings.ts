...
import { iHeaterSettings } from '../../interfaces';

export class HeaterSettings extends DeviceSettings implements iHeaterSettings {
  /**
  ...
  public toJSON(): Partial<HeaterSettings> {
