import { iActuatorSettings } from '../../interfaces';
import { DeviceSettings } from './deviceSettings';
import { Utils } from '../../utils';

export class ActuatorSettings extends DeviceSettings implements iActuatorSettings {
  /**
  ...
  public toJSON(): Partial<ActuatorSettings> {
